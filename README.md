...
#### 🤖 [Real-time Edu-Social Platform](https://github.com/tam130103/datn)
*A comprehensive social platform for universities with AI-driven content moderation.*
- **Tech**: NestJS, React, PostgreSQL, Socket.io, Dify AI.
- **Key Features**: Real-time messaging, dynamic newsfeed, and automated AI moderation for safe community interactions.
- **Demo**: [Live Link](https://datn-mu-six.vercel.app/)

#### 📊 [ESG Logic & Backend Systems](https://github.com/tam130103)
*Complex calculation engines and system architecture developed during internship.*
- **Focus**: High-performance API design, complex logical operations for ESG (Environmental, Social, and Governance) metrics, and data integrity.
- **Key Achievements**: Optimized data flows and improved system reliability for large-scale calculations.

#### 🍔 [Food Delivery Ecosystem](https://github.com/tam130103/DACN)
*Full-stack e-commerce solution with integrated payment and management dashboard.*
- **Tech**: Node.js, Express, MongoDB, Stripe API.
- **Features**: Real-time order tracking, secure payment processing, and a premium admin dashboard for business management.
